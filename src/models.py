...
#         print("state: ", state.size())
        ...
        output["loss"] = self.loss(class_logits, torch.max(label, 1)[1]) # because CrossEntropyLoss expects class indices, and not one-hot vectors - https://discuss.pytorch.org/t/runtimeerror-multi-target-not-supported-newbie/10216
        return output
